...
# ==========================================
# 1. ISSUE TRIAGE (Duplicate Detection)
# ==========================================
...
class DuplicateResult(BaseModel):
    ...
    """
    is_duplicate: bool
    similarity_score: float = Field(..., ge=0.0, le=1.0, description="Cosine similarity score from 0.0 to 1.0")
    duplicate_of_number: Optional[int] = Field(default=None, description="The issue number this duplicates")


# ==========================================
# 2. PR ROUTING (Reviewer Assignment)
# ==========================================
...
class ReviewerScore(BaseModel):
    ...
    """
    github_username: str
    relevance_score: float = Field(..., description="Calculated weight based on commit history")
